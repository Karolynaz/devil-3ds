...
#ifdef __3DS__
#define CTR_DEFAULT_BUTTON(btn) ControllerButton_NONE
#else
#define CTR_DEFAULT_BUTTON(btn) (btn)
#endif
	...
	options.Padmapper.AddAction(
	    ...
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_B),
	    [] {
	...
	options.Padmapper.AddAction(
	    ...
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_Y),
	    [] {
	...
	options.Padmapper.AddAction(
	    ...
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_X),
	    [] {
	...
	options.Padmapper.AddAction(
	    ...
	    N_("Cancel action"),
	    N_("Close menus."),
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_A),
	    [] {
		    if (DoomFlag) {
			    doom_close();
			    return;
	...
	options.Padmapper.AddAction(
	    ...
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_DPAD_UP),
	    [] {});
	options.Padmapper.AddAction(
	    "MoveDown",
	    N_("Move down"),
	    N_("Moves the player character down."),
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_DPAD_DOWN),
	    [] {});
	options.Padmapper.AddAction(
	    "MoveLeft",
	    N_("Move left"),
	    N_("Moves the player character left."),
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_DPAD_LEFT),
	    [] {});
	options.Padmapper.AddAction(
	    "MoveRight",
	    N_("Move right"),
	    N_("Moves the player character right."),
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_DPAD_RIGHT),
	    [] {});
	options.Padmapper.AddAction(
	    "StandGround",
	    N_("Stand ground"),
	...
	options.Padmapper.AddAction(
	    ...
	    N_("Use health potion"),
	    N_("Use health potions from belt."),
	    CTR_DEFAULT_BUTTON(ControllerButton_BUTTON_LEFTSHOULDER),
	    [] { UseBeltItem(BeltItemType::Healing); },
	    nullptr,
	    CanPlayerTakeAction);
#undef CTR_DEFAULT_BUTTON
	options.Padmapper.AddAction(
	    "UseManaPotion",
	    N_("Use mana potion"),
	    N_("Use mana potions from belt."),
